...
{ 
	...
	else if((salary>=300) && (salary<400))
	{
		...
		int newValue = oldvalue+1;
		count[1]=newValue;
		System.out.println("The salespeople earned salaries in this range "+count[1]);
	}
	else if((salary>=400) && (salary<500))
	{
			...
			int newValue = oldvalue+1;
			count[2]=newValue;
			System.out.println("The salespeople earned salaries in this range "+count[2]);
	}
	else if((salary>=500) && (salary<600))
	{
				...
				int newValue = oldvalue+1;
				count[3]=newValue;
				System.out.println("The salespeople earned salaries in this range "+count[3]);
	}
	else if((salary>=600) && (salary<700))
	{
				...
				int newValue = oldvalue+1;
				count[4]=newValue;
				System.out.println("The salespeople earned salaries in this range "+count[4]);
	}
	else if((salary>=700) && (salary<800))
	{
					...
					int newValue = oldvalue+1;
					count[5]=newValue;
					System.out.println("The salespeople earned salaries in this range "+count[5]);
	}
	else if((salary>=800) && (salary<900))
	{
						...
						int newValue = oldvalue+1;
						count[6]=newValue;
						System.out.println("The salespeople earned salaries in this range "+count[6]);
	}
	else if((salary>=900) && (salary<1000))
	{
					...
					int newValue = oldvalue+1;
					count[7]=newValue;
					System.out.println("The salespeople earned salaries in this range "+count[7]);
	}
	else if(salary>1000) 
	{
					...
					int newValue = oldvalue+1;
					count[8]=newValue;
					System.out.println("The salespeople earned salaries in this range "+count[8]);
	}
	else 
	{
		...
		int newValue = oldvalue+1;
		count[9]=newValue;
		System.out.println("The salespeople earned salaries in this range "+count[9]);
	}
} 
